...
alias terminal_proxy_all_clashx_m="export https_proxy=http://127.0.0.1:7890 http_proxy=http://127.0.0.1:7890 all_proxy=socks5://127.0.0.1:7890"
...
alias kill_jellyfish_m="ps -ef | grep jellyfin-mpv-shim | awk '{print $2}'|xargs kill -9"

# aria2 deamon
alias aria2_deamon_m="aria2c --conf-path=$HOME/.aria2/aria2.conf -D"
